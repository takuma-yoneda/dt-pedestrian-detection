# parameters
ARG REPO_NAME="dt-pedestrian-detection"
ARG DESCRIPTION="Pedestrian detection and image segmentation with PyTorch"
ARG MAINTAINER="Takuma Yoneda (takuma.ynd@gmail.com)"
